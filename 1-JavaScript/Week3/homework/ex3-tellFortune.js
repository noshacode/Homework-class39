...
function main() {
  const numKids = [2,1,3,0,5];
  const partnerNames = ["Abdullah","Jack","Ruby","Rama","Lubna"];
  const locations = ["Amsterdam","Malaysia","Aden","France","Italy"];
  const jobTitles = ["product manger","team lead","tester","software developer","teacher"];
